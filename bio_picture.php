...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
	...
	*/
	...
	$query = "INSERT INTO bio (id, picture) VALUES ('$_POST[id]', '$_POST[picture]') ON DUPLICATE KEY UPDATE picture='".$picture."'";
	...
	$query="SELECT picture FROM bio WHERE id ='".$_REQUEST['id']."'";
